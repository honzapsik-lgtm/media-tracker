...
- **Global Leaderboards & Personal Rankings**: Build personal drag-and-drop ranking lists on your profile. The app mathematically calculates true "List Ranks" to form community-driven global leaderboards across all media categories.
